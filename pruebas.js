...
formClientereg.addEventListener("submit", function(event){
                ...
                alert("La venta ha sido registrada exitosamente" ,"success");
...
function cargarFrutas(){
    ...
    if(lista_frutas.length>0){
        ...
        for(let fruta in lista_frutas ){  
            ...
            newlistaCell.textContent = lista_frutas[fruta].nameClient

            newlistaCell = newlistaRow.insertCell(2);
            newlistaCell.textContent = lista_frutas[fruta].seller

            newlistaCell = newlistaRow.insertCell(3);
            newlistaCell.textContent = lista_frutas[fruta].totalCost
